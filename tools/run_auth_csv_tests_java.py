...
DEFAULT_BOOTSTRAP = os.getenv("RED_KAFKA_AUTH_BOOTSTRAP", "")
DEFAULT_ANONYMOUS_BOOTSTRAP = os.getenv("RED_KAFKA_AUTH_ANONYMOUS_BOOTSTRAP", "")
DEFAULT_CSV = "auth_tests_verification.example.csv"
...
REQUIRED_RUNTIME_JAR_GLOBS = (
    ...
    GRADLE_CACHE
    + "/com.xiaohongshu/infra-framework-context/3.3.7-RELEASE/*/"
    + "infra-framework-context-3.3.7-RELEASE.jar",
...
def parse_args():
    ...
    parser.add_argument(
        "--kafka-clients-jar",
        default=os.getenv("RED_KAFKA_CLIENTS_JAR", ""),
    )
    parser.add_argument(
        "--kafka-clients-classes-dir",
        default=os.getenv("RED_KAFKA_CLIENTS_CLASSES_DIR", ""),
    )
