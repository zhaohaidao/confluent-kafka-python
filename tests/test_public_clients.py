...
from confluent_kafka.cimpl import Consumer as CConsumerAlias
from confluent_kafka.cimpl import Producer as CProducerAlias
...
def test_cimpl_keeps_legacy_client_aliases():
    assert CProducerAlias is CProducer
    assert CConsumerAlias is CConsumer
